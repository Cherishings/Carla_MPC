...
A = np.array([
    [9.6483344e-01, 1.9321683e-01, 3.6146561e-05],
    [8.5808896e-03, 9.1975677e-01, -6.2482341e-06],
    [5.0099257e-05, -5.7547394e-02, 9.8631752e-01]
], dtype=np.float32)

B = np.array([
    [3.2021693e-04, -7.2493032e-02],
    [-4.2146516e-05, 2.5080540e-03],
    [-2.3801133e-01, 5.5870771e-02]
], dtype=np.float32)

Q = np.array([
    [1.2016636, -0.64091665, -1.2616336, 0.2084447, -0.6139916],
    [-0.64091665, 0.47452974, 0.46126127, 0.22803439, 0.7065983],
    [-1.2616336, 0.46126127, 1.6627548, -0.7836031, 0.06352085],
    [0.2084447, 0.22803439, -0.7836031, 4.169936, -4.3379936],
    [-0.6139916, 0.7065983, 0.06352085, -4.3379936, 10.987052]
], dtype=np.float32)
...
def main():
    ...
    try:
        while True:
            ...
            xrefs = build_mpc_refs_zoh_idx(wps_ego_smooth, tgt_speed_mps=tgt_speed_mps, cur_speed_mps=speed_mps,
                               idx=LOOKAHEAD_INDEX, horizon=N)
